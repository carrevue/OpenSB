...
if ($database->result("SELECT COUNT(rating) FROM upload_ratings WHERE video=? AND user=?", [$database->result("SELECT id FROM uploads WHERE upload_id=?", [$_POST['vidid']]), $auth->getUserID()]) != 0) {
    $database->query(
