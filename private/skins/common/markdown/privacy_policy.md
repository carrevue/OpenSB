...
## Cookies
This platform uses a cookie (`SBAUTH`) to keep you logged in. This cookie should not be publicly disclosed to *anyone* as it will make them able to log into your account(s).
